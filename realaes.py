...
class AES:
    ...
    def encrypt_block(self, plaintext):
        ...
        for i in range(1, self.n_rounds):
            ...
            print(matrix2bytes(plain_state), plain_state)
...
if __name__ == '__main__':
	import numpy as np
	hello = AES(b'\xdeEu"\xfd\xbf4\xc54\xc8\xa1\xb7\xe8\x88Di')
	for L in hello._key_matrices:
		a = np.array(L, dtype=np.uint8).transpose()
		print(a)
